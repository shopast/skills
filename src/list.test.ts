...
`
  ...
  describe('help output', () => {
    ...
    it('should include list examples in help', () => {
      const result = runCli(['--help']);
      expect(result.stdout).toContain('skillycli list');
      expect(result.stdout).toContain('skillycli ls -g');
      expect(result.stdout).toContain('skillycli ls -a claude-code');
    });
  });
  ...
  describe('banner', () => {
    it('should include list command in banner', () => {
      const result = runCli([]);
      expect(result.stdout).toContain('npx skillycli list');
      expect(result.stdout).toContain('List installed skills');
    });
  });
});
